...
public class MainActivity extends AppCompatActivity {
    ...
    private void firstRun(){
     //   getSharedPreferences("ss_char",0).edit().putBoolean("setup",false).commit();

        SharedPreferences.Editor data;
     //  if (getSharedPreferences("ss_char",0).getBoolean("setup",false)) {
           Log.i("setup","first run");
           ...
           data.putString("ABILHINT", "CHA").apply();
       //    getSharedPreferences("ss_char",0).edit().putBoolean("setup",true).apply();
     //  }
